...
if("TRUE" STREQUAL "TRUE")
  set(lidar_localization_SOURCE_PREFIX /workspace/assignments/02-lidar-odometry-basic/src/lidar_localization)
  set(lidar_localization_DEVEL_PREFIX /workspace/assignments/02-lidar-odometry-basic/devel/.private/lidar_localization)
  ...
  set(lidar_localization_INSTALL_PREFIX /workspace/assignments/02-lidar-odometry-basic/install)
...
if(NOT "/workspace/assignments/02-lidar-odometry-basic/devel/.private/lidar_localization/include " STREQUAL " ")
  set(lidar_localization_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/assignments/02-lidar-odometry-basic/devel/.private/lidar_localization/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Ge Yao <alexgecontrol@qq.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lidar_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/assignments/02-lidar-odometry-basic/src/lidar_localization/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/assignments/02-lidar-odometry-basic/devel/.private/lidar_localization/lib;/workspace/assignments/02-lidar-odometry-basic/install/lib;/opt/ros/melodic/lib)
