...
if("TRUE" STREQUAL "TRUE")
  set(lidar_localization_SOURCE_PREFIX /workspace/assignments/09-graph-optimization/src/lidar_localization)
  set(lidar_localization_DEVEL_PREFIX /workspace/assignments/09-graph-optimization/devel/.private/lidar_localization)
  ...
  set(lidar_localization_INSTALL_PREFIX /workspace/assignments/09-graph-optimization/install)
...
if(NOT "/workspace/assignments/09-graph-optimization/devel/.private/lidar_localization/include " STREQUAL " ")
  set(lidar_localization_INCLUDE_DIRS "")
  set(_include_dirs "/workspace/assignments/09-graph-optimization/devel/.private/lidar_localization/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lidar_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/workspace/assignments/09-graph-optimization/src/lidar_localization/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /workspace/assignments/09-graph-optimization/devel/.private/lidar_localization/lib;/workspace/assignments/09-graph-optimization/install/lib;/opt/ros/melodic/lib)
