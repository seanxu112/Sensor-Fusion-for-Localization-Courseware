...
#ifndef LIDAR_LOCALIZATION_MODELS_FLOAM_REGISTRATION_HPP_
#define LIDAR_LOCALIZATION_MODELS_FLOAM_REGISTRATION_HPP_
...
public:
    ...
    CeresFLOAMRegistration(const Config& config, const Eigen::Quaterniond &dq, const Eigen::Vector3d &dt);
    ~CeresFLOAMRegistration();
